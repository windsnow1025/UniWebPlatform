...
New user start with 0 credits. Pay as you go. Contact the author to receive 5 free credits.
...
- User input: `user`
- Global rules: `system`
- Model generation: `assistant`.

Disable Microsoft Editor to avoid unintended changes.
For issues, disable extensions and refresh (`Ctrl + F5`). If the problem still occurs, contact the author.
